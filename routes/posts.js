...
module.exports = (app) => {
  ...
  router.get('/p/:post_path/edit', (req, res) => {
    app.render(req, res, '/admin/edit-post', { ...req.query, path: req.params.post_path });
  });

  router.get('/p/:post_path/translations/new', (req, res) => {
    app.render(req, res, '/admin/edit-post-translation', { ...req.query, post: req.params.post_path });
  });

  router.get('/p/:post_path/translations/:translation_language/edit', (req, res) => {
    app.render(req, res, '/admin/edit-post-translation', {
      ...req.query,
